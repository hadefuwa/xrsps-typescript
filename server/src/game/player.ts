...
export class PlayerState extends Actor {
    ...
    getEquipmentCharges(itemId: number): number {
        return this.equipment.getCharges(itemId);
    }

    /** @deprecated Use player.equipment.setCharges() directly */
    setEquipmentCharges(itemId: number, charges: number): void {
        this.equipment.setCharges(itemId, charges);
    }

    /** @deprecated Use player.equipment.hasEquippedItem() directly */
    hasEquippedItem(slot: EquipmentSlot, itemId: number): boolean {
        return this.equipment.hasEquippedItem(this.appearance, slot, itemId);
    }
